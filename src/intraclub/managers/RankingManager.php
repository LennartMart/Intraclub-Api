...
class RankingManager {
    ...
    public function get($seasonId = null, $roundId = null){
        ...
        //Build the rankings
        $generalRanking = $this->buildRanking($ranking, $previousRanking, "filterNothing");
        $womanRanking = $this->buildRanking($ranking, $previousRanking, "filterWoman");
        $recreantRanking = $this->buildRanking($ranking, $previousRanking, "filterRecreant");
        $veteranRanking = $this->buildRanking($ranking, $previousRanking, "filterVeteran");
        ...
        $response = array(
            ...
            "women" => $womanRanking, 
            "recreant" => $recreantRanking,
            "veteran" => $veteranRanking);
        return $response;
    }
    ...
    */
    private function buildRanking($ranking, $previousRanking, $filterfunction){
        ...
        for($index = 0; $index < count($specificCurrentRanking); $index++){
